		...
		<div class="container">
			<center>
				<table border="1" width="90%">
					...
					<?php
					$query = "select * from org_req where status = 'approved' order by id ASC";
					...
					?>
						<tr>
							...
							<td style="text-align:center;"><?php echo $row['org_lead']; ?></td>
							...
							<td style="text-align:center;"><?php echo $row['org_address']; ?></td>
							<td style="text-align:center;">
								<form action="usr.php" method="post">
									<input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
									<center><a id="color" href="orgupdate.php?id=<?php echo $row['id']; ?>" onClick="return confirm('Confirm Update?')">Update</a></center>
									<center><a id="color" href="orgdelete.php?id=<?php echo $row['id']; ?>" onClick="return confirm('Confirm Delete?')">Delete</a></center>
								</form>
							</td>
						</tr>
					<?php
