        ...
        <div class="container">
            <center>
                <table border="1" width="90%">
                    ...
                    <?php
                    $query = "select * from field order by f_id ASC";
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <form action="usr.php" method="post">
                                    ...
                                    <center><a href="fupdate.php?f_id=<?php echo $row['f_id']; ?>" onClick="return confirm('Confirm Update?'))">Update</a></center>
                                    <center><a href="fdelete.php?f_id=<?php echo $row['f_id']; ?>" onClick="return confirm('Confirm Delete?')">Delete</a></center>
                                </form>
                            </td>
                        </tr>
                    <?php
