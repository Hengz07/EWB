<?php
  ...
  $query = "select * from quickplay where pid=".$_GET['check']." and gate = ".$_GET['g']." limit 1";
  $resultSingleScore = mysqli_query($con, $query);
  $singleScore = mysqli_fetch_assoc($resultSingleScore);

    $stgate = $singleScore['gate'];
    $par = $singleScore['par'];
      ...
      <div class="container">
        ...
        <form action="updatescore.php" method="post">
          ...
          <table>
            ...
            <tr>
              <td>Point</td>
              <td><h2 style="text-align:center;" id="point"></h2><input type="hidden" name="point" id="pointSave" value=""></td>
            </tr>
            <tr>
              <td>OB</td>
              <td><h2 style="text-align:center;" id="obp"></h2><input type="hidden" name="ob" id="obSave" value=""></td>
            </tr>
            <tr>
              <td>Max</td>
              <td><h2 style="text-align:center;" id="max"></h2></td>
            </tr>
          </table>
        </center>
      <input type="hidden" name="singleScoreId" value="<?php echo $_GET['check'] ?>">
      <input type="hidden" name="singlePlayerId" value="<?php echo $singleScore['qid'] ?>">

      <div class="position">
        <center>
        <table>
          <tr>
            <td><a id="aa" href="#" onclick="tick()" id="a"><b>Tick</b></a></td>
            <td><a id="bb" href="#" onclick="undot()" id="d"><b>Undo<br>Tick</b></a></td>
          </tr>
          <tr>
            <td><a id="aa" href="#" onclick="ob()" id="b"><b>OB</b></a></td>
            <td><a id="bb" href="#" onclick="undoo()" id="c"><b>Undo<br>OB</b></a></td>
          </tr>
        </table>
        <br>
