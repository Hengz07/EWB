        ...
        <div class="form animate__animated animate__bounceIn">
            ...
            <div class="position">
                <table class="animate__animated animate__fadeInLeft">
                    ...
                    <tr>
                        <td><b>
                                <p style="float: left; padding-left: 20px; text-align:center;">Marshal Name:</p>
                            </b></td>
                        <td><b>
                                <p style="float: left; padding-left: 20px; text-align:center;"><?php echo $mar_data['marname']; ?></p>
                            </b></td>
                    </tr>
                    <tr>
                        <td><b>
                                <p style="float: left; padding-left: 20px; text-align:center;">Par:</p>
                            </b></td>
                        <td><b>
                                <p style="float: left; padding-left: 20px; text-align:center;"><?php echo $thispar; ?></p>
                            </b></td>
                    </tr>
                    <tr>
                        <td><b>
                                <p style="float: left; padding-left: 20px; text-align:center;">Max:</p>
                            </b></td>
                        <td><b>
                                <p style="float: left; padding-left: 20px; text-align:center; " id="maxp"><?php $max = $thispar * 3;
                                                                                                            echo $max; ?></p>
                            </b></td>
                    </tr>
                </table>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; font-weight:bold;">
                                        <h2 id="point<?php echo $id; ?>"></h2><input type="hidden" name="pointsave<?php echo $id; ?>" id="savepoint<?php echo $id; ?>">
                                    </td>
                                    <td style="text-align: center; font-weight:bold;">
                                        <h2 id="ob<?php echo $id; ?>"></h2><input type="hidden" name="obsave<?php echo $id; ?>" id="saveob<?php echo $id; ?>">
                                    </td>
                                    <td>
            ...
            <!-- <center><a class="aa" onclick="return confirm('Confirm Reset Gate Point?');" href="undo.php?gate=<?php //echo $gate."&game=".$gameid;
                                                                                                                    ?>"><b>Reset</b></a></center> -->
