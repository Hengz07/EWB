...
<body>
	...
	<div class="animate__animated animate__bounceIn ok">
		...
		<div class="container">
			<center>
			<a class="animate__animated animate__bounceInLeft" href="regismar.php"><b>Register Marshal</b></a>
			<a class="animate__animated animate__bounceInRight" href="marshal.php"><b>Marshal Record</b></a>
			<!--<a href="#"><b>Marshal Record</b></a>-->
			</center>
		</div>
	</div>
	</center>
